                        ...
                        <table id="pageList" class="table table-bordered table-striped table-responsive">
                            ...
                            @foreach($bank_accounts as $bank_account)
                                <tr>
                                    ...
                                    <td>{{$bank_account->mobile}}</td>
                                    <td>{{$bank_account->email}}</td>
                                    <td>{{$bank_account->address}}</td>
                                    <td>{{$bank_account->bankName}}</td>
                                    <td>{{$bank_account->branchName}}</td>
                                    <td>
                                        <form action="{{ route('bankAccount.destroy',$bank_account->id)}}" method="POST">
                                            <a href="{{route('bankAccount.edit',$bank_account->id)}}"
